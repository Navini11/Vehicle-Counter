...
video_path = r'D:\cpp cousera\computer vision\extra youtube\4236781-hd_1920_1080_25fps.mp4'
cap = cv2.VideoCapture(video_path)
model = YOLO('yolov8n.pt')

classnames = []
with open('D:\cpp cousera\computer vision\extra youtube\Vehicle-Counting-in-Lanes-main\Vehicle-Counting-in-Lanes-main\classes.txt', 'r') as f:
    classnames = f.read().splitlines()

road_zoneA = np.array([[200, 50], [500,50 ], [475, 450], [175,450], [200, 50]], np.int32)
road_zoneB = np.array([[675, 50], [975, 50], [950, 450], [650, 450], [675, 50]], np.int32)
road_zoneC = np.array([[1150, 50], [1450, 50], [1475, 450], [1175, 450], [1150, 50]], np.int32)
